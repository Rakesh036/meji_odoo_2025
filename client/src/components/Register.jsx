...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#E4E0E1] to-[#D6C0B3] py-8">
      <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-lg">
        <h2 className="text-3xl font-bold text-center mb-8 text-[#493628]">Sign Up</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">
              What's your pet name? (for password recovery)
            </label>
            <input
              type="text"
              name="petName"
          ...
          <div className="text-center text-sm text-gray-600">
            ...
            <Link to="/login" className="text-[#AB886D] hover:text-[#493628] font-medium">
              Login
            </Link>
          </div>
        </form>
